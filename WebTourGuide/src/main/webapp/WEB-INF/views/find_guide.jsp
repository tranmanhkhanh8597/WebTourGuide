            ...
            <div class="row content-area">
                <div id="content" class="columns-12 site-content" role="main">
                    <div class="page-title">
                        ...
                        <p><a href=""><small>World&nbsp;map</small></a><small>&nbsp;»&nbsp;</small> <a href=""><small>Asia (south east)&nbsp;map</small></a> </p>
                    </div>
                    <div id="content" class="columns-8 site-content region-content column-right column-reset" role="main">
                        <p>Browse our guides - each guide has tour 'suggestions' and is willing to customize them just for you!</p>
                        <p> There are 18 local guides in Hanoi-Vietnam. </p>
                        <br />
                        ...
                        <c:forEach  items="${lsGuiderCustom}" var ="lsGuiderCustom">
                            <div class="guide-loop">
                                <div class="card-holder">
                                    <div class="columns-3">
                                        <div class="image-holder avatar-holder">
                                            <a rel="nofollow" class="read-more" href=""> 
                                                <img border="0" width="120" height="120" alt="Private tour guide Sammy N." class="lazy" src="https://www.toursbylocals.com/images/guides/31/31735/2018230231041228.jpg" style="display: block;" /> 
                                            </a>
                                        </div>
                                    </div>
                                    <div class="columns-9">
                                        <div class="card-box">
                                            <h3><a href="find_guide_detail?id=${lsGuiderCustom._id}">${lsGuiderCustom.fullName}</a></h3> 
                                            <span>${lsGuiderCustom.country}</span>
                                            <div class="guide-rating"> <b>Rating</b>
                                                <div class="rating-holder orange">
                                                    <a style="text-decoration: none; cursor: pointer;" href=""> <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>&nbsp;(60) </a>
                                                </div>
                                            </div>
                                            <p><b>Languages:</b>&nbsp;${lsGuiderCustom.languages}</p>
                                            <p><b>Biography:</b>&nbsp;${lsGuiderCustom.biography}</p>
                                            <p><b>Credentials:</b>&nbsp;${lsGuiderCustom.credentials}</p>
                                            <p> <a rel="nofollow" class="read-more" href="find_guide_detail?id=${lsGuiderCustom._id}">Learn More</a> <a rel="nofollow" class="read-more" href="">Message ${lsGuiderCustom.fullName}</a> </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
